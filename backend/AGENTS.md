...
| `GET /api/inbox/folders?parent=<name>` | yes | Lists immediate child folders under an IMAP mailbox parent; omit `parent` to list top-level non-Archive mailbox links for the inbox nav |
